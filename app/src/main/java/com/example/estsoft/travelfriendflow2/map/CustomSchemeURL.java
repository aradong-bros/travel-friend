...
/**
 * Created by yeonji on 2016-07-26.
 * 모바일에 등록되지 않은 Scheme인 경우 앱 설치 유도
 */
public abstract class CustomSchemeURL {
    ...
    public CustomSchemeURL(Context context, Intent intent){
        this.mContext = context;
        this.mIntent = intent;
    }

    /**
     * 다음맵 scheme을 처리할 수 있는 어플리케이션이 존재하는지 검사
